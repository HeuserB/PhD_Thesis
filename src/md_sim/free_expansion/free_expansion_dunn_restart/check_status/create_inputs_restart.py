...
def input_temp(in_txt, slurm_txt, temp, grid_constant, n_cells, last_step,t_init=17000.0,seed=123456789):
    ...
    outfile = 'restart_inputs/in.free_expansion_dunn_' + str(temp) + 'K_' +str(n_cells) +'x' + str(n_cells) +'x' + str(n_cells) + 'grid_' + str(grid) + '_restart'
    ...
    outfile_slurm  = 'restart_inputs/lammps.free_expansion_dunn_' + str(temp) +'K_' +str(n_cells) +'x' + str(n_cells) +'x' + str(n_cells) + 'grid_' + str(grid)
