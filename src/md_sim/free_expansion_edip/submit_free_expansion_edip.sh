...
python3 free_expansion_edip.py
tar -czvf free_expansion.tar.gz inputs_free_expansion
rm -r inputs_free_expansion
scp free_expansion.tar.gz bh326@titan1.hpc.uni-rostock.de:/home/bh326/free_expansion_edip/
rm free_expansion.tar.gz

ssh bh326@titan1.hpc.uni-rostock.de 'cd ~/free_expansion_edip/  && tar -xf free_expansion.tar.gz'