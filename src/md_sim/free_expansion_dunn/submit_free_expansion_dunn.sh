...
scp free_expansion.tar.gz bh326@titan1.hpc.uni-rostock.de:/home/bh326/free_expansion_dunn/
rm free_expansion.tar.gz

ssh bh326@titan1.hpc.uni-rostock.de 'cd ~/free_expansion_dunn/  && tar -xf free_expansion.tar.gz'
